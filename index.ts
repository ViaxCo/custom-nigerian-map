...
const paths: NodeListOf<Element> = document.querySelectorAll(".svg-path");
...
paths.forEach((path) => {
  ...
  path.addEventListener("mouseenter", () => {
    tooltip.innerHTML = path.getAttribute("title") as string;
